...
- **Не разкрасявай.** Паднал тест, недовършен таск, открито разминаване — назовават се направо, с това какво точно е счупено и какво е нужно за поправка. Отчет, който крие дефект, излиза по-скъпо от самия дефект.
