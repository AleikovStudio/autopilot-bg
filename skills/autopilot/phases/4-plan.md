...
Клиентът пише на бота, отговаря на три въпроса — какво се е повредило, адрес, телефон —
и получава потвърждение с номер на заявката. Ако връзката е паднала по средата,
следващото съобщение продължава от там, а не започва отначало.

## От брифа, дословно

> „приема заявки за ремонт на техника“
> „за да вижда клиентът статуса“

## Раздели от спецификацията

Истории 1–5, Решения §2 и §4, Точки за тестване §1.

## Критерии за приемане

- [ ] Диалогът от три стъпки стига до потвърждение
- [ ] Номерът на заявката е уникален и видим за клиента
- [ ] Прекъснат диалог продължава, а не се нулира
- [ ] Незапълнен телефон дава разбираема грешка, а не срив
- [ ] Тестът в точка §1 покрива целия път и прекъсването
```
...
**Forward:** every `in-spec` requirement appears in at least one ticket's Изисквания line. A requirement in no ticket does not get built.
